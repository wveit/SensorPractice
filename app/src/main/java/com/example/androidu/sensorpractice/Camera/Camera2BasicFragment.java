...
import com.example.androidu.sensorpractice.Camera.AutoFitTextureView;
import com.example.androidu.sensorpractice.CameraActivity;
...
public class Camera2BasicFragment extends Fragment
    ...
    private CameraActivity.CameraLayoutCallback mCamLayoutCallback;

    @Override
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        mTextureView = (AutoFitTextureView) view.findViewById(R.id.texture);

        if (mCamLayoutCallback != null)
            mCamLayoutCallback.setUpLayout((LinearLayout) view.findViewById(R.id.surface));
    }
    ...
    public void setCamLayoutCallback(CameraActivity.CameraLayoutCallback callback) {
        mCamLayoutCallback = callback;
    }
